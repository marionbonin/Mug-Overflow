    ...
    <>
      ...
      <Page>
        ...
        <div id="cgu-content">
          ...
          <h2 className="cgu-title">Propriété intellectuelle</h2>
          <p className="cgu-p">
          Tout contenu publié et mis à disposition sur ce site est la propriété de Mug Overflow et de ses créateurs. Cela comprend, mais n’est pas limité aux images, textes, logos, documents, fichiers téléchargeables et tout ce qui contribue à la composition de ce site.
          </p>

          <h2 className="cgu-title">Contributions d'utilisateur </h2>
          <p className="cgu-p">
          Les utilisateurs peuvent publier les informations suivantes sur notre site : fichiers photos (jpg, png, svp).
          ...
          <h2 className="cgu-title">Comptes</h2>
          <p className="cgu-p">
          Lorsque vous créez un compte sur notre site, vous acceptez ce qui suit :
          </p>
          <p className="cgu-p">1. que vous êtes seul responsable de votre compte et de la sécurité et la confidentialité de votre compte, y compris les mots de passe ou les renseignements de nature délicate joints à ce compte
          </p>
          <p className="cgu-p">2. que tous les renseignements personnels que vous nous fournissez par l’entremise de votre compte sont à jour, exacts et véridiques et que vous mettrez à jour vos renseignements personnels s’ils changent.
          </p>
          ...
          <h2 className="cgu-title">Limitation de responsabilité</h2>
          <p className="cgu-p">
            Mug Overflow ou l’un de ses créateurs sera tenu responsable de tout problème découlant de ce site. Néanmoins, ceux-ci ne seront pas tenus responsables de tout problème découlant de toute utilisation irrégulière de ce site.
          </p>

          <h2 className="cgu-title">Lois applicables</h2>
          <p className="cgu-p">
          ...
          <h2 className="cgu-title">Divisibilité</h2>
          <p className="cgu-p">
          ...
          <h2 className="cgu-title">Modifications</h2>
          <p className="cgu-p">
